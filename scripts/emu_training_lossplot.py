...
def plot_training_curve(data, server_idx):
    ...
    plt.subplot(3, 1, 1)
    plt.plot(data["epoch"], data["loss"], marker="o", linestyle="-", label="Loss")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    ...
    plt.subplot(3, 1, 2)
    plt.plot(data["epoch"], data["avg_reward"], marker="o", linestyle="-", label="Avg Reward", color="green")
    plt.xlabel("Epoch")
    ...
    plt.subplot(3, 1, 3)
    plt.plot(data["epoch"], data["avg_entropy"], marker="o", linestyle="-", label="Avg Entropy", color="red")
    plt.xlabel("Epoch")
